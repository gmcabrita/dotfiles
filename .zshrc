...
export MIX_OS_DEPS_COMPILE_PARTITION_COUNT=$(nproc --all 2>/dev/null || sysctl -n hw.perflevel0.logicalcpu 2>/dev/null || sysctl -n hw.ncpu 2>/dev/null || getconf _NPROCESSORS_ONLN 2>/dev/null || echo 1)
