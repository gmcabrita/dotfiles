...
brew install --cask 1password orbstack betterdisplay google-chrome brave-browser linearmouse zed sublime-text httpiee monodraw karabiner-elements db-browser-for-sqlite google-cloud-sdk slack whatsapp signal zoom raycast shureplus-motiv plex-media-server setapp macrorecorder modern-csv macs-fan-control whisky homebrew/cask-fonts/font-jetbrains-mono homebrew/cask-fonts/font-inter telegram hyperkey chatgpt NetNewsWire linear-linear ghostty
