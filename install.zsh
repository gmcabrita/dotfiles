...
brew install --cask 1password alacritty orbstack betterdisplay google-chrome linearmouse zed httpiee cleanshot monodraw google-chrome karabiner-elements db-browser-for-sqlite google-cloud-sdk spotify slack whatsapp telegram signal zoom raycast cron cleanshot shureplus-motiv plex-media-server livebook tableplus
brew install --formula git gh sqlite fzf dos2unix colordiff bash asdf git-extras git-delta gnu-time jq fq less moreutils ncdu ripgrep grep rlwrap scc asciinema tree libpq cloud-sql-proxy glow gum mods vhs google-cloud-sdk gnu-tar gpg htop elixir-ls tailspin 1password-cli yt-dlp pgcli litecli
