...
brew install --cask 1password alacritty orbstack betterdisplay google-chrome linearmouse zed httpiee monodraw karabiner-elements db-browser-for-sqlite google-cloud-sdk spotify slack whatsapp telegram signal zoom raycast shureplus-motiv plex-media-server livebook setapp
